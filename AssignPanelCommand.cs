...
namespace FZFZ
{
    ...
    /// </summary>
    [Guid("41c8c3ae-407a-40f4-b84c-35993325eb26")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("FZFZ.CommandAssignPanelCommand")]
    public sealed class AssignPanelCommand : BaseCommand
    {
        private IApplication m_application;
        private IDockableWindow m_dockableWindow;

        private const string DockableWindowGuid = "{3f8b9529-5dc4-4bea-a3ab-1bccdecab897}";
        ...
        public AssignPanelCommand()
        {
            ...
            base.m_name = "DeveloperTemplate_AssignPanelCommand";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
